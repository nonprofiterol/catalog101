...
abstract class  PtsWidgetPageBuilder extends Model {
	...
	public function getLayout( $layout ){ 
		...
		$theme_default_directory = $config->get("theme_default_directory");

		if (file_exists(DIR_TEMPLATE . $theme_default_directory . '/template/extension/module/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE. $theme_default_directory . '/template/extension/module/widgets/'.$layout.'.tpl';
		} else {
