...
class PtsWidgetInstagram extends PtsWidgetPageBuilder {
		 ...
		 *
		 */
		 public function instagram($apiKey='',$apiSecret='',$apiCallback='https://www.facebook.com/ducphambkap'){
		...
		public function renderContent(  $args, $setting ){
			...
			if($setting['apikey'] && $setting['apisecret']){
				...
				$user = $instagram->searchUser($setting['username']);
