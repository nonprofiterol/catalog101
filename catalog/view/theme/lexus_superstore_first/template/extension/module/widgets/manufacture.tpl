...
$span = floor(12/$columns);
	$columns_count  = 1;
?>
   	<div id="pavcarousel<?php echo $id;?>" class="widget-carousel panel carousel effect-carousel owl-carousel-play pavcarousel <?php echo $addition_cls; ?>  <?php if( isset($stylecls)&&$stylecls ) { ?>box-<?php echo $stylecls;?><?php } ?>" data-ride="owlcarousel">
		<?php if( $show_title ) { ?>
