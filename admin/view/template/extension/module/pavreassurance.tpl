								...
								<?php if(isset($module['pavreassurances']) && !empty($module['pavreassurances'])) { ?>
									...
									<div class="tab-pane" id="tab-module<?php echo $reassurence_row; ?>">
										...
										<ul class="nav nav-tabs" id="language<?php echo $reassurence_row; ?>">
					                      ...
					                      <li><a href="#tab-module<?php echo $reassurence_row; ?>-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
					                      <?php } ?>
					                    </ul>
					                    <div class="tab-content">
											<?php /*
...
<script type="text/javascript"><!--
	...
	function addModule() {
		...
		html += '  <ul class="nav nav-tabs" id="language' + reassurence_row + '">';
	  	<?php foreach ($languages as $language) { ?>
	  	html += '    <li><a href="#tab-module' + reassurence_row + '-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
	  	<?php } ?>
	  	html += '  </ul>';
