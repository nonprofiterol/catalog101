...
class ControllerExtensionModulePavautosearch extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/pavautosearch', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$this->response->setOutput($this->load->view('extension/module/pavautosearch.tpl', $this->mdata));
	}
	...
	public function _breadcrumbs(){
		$this->mdata['breadcrumbs'] = array();
   		...
   		$this->mdata['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/pavautosearch', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
	}
	...
	public function _language(){
		...
		$this->mdata['action'] = $this->url->link('extension/module/pavautosearch', 'token=' . $this->session->data['token'], 'SSL');
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/pavautosearch')) {
