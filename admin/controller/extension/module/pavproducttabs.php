...
class ControllerExtensionModulePavproducttabs extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				...
				$this->response->redirect($this->url->link('extension/module/pavproducttabs', 'token=' . $this->session->data['token'], 'SSL'));
			} else {
				$this->model_extension_module->editModule($this->request->get['module_id'], $this->request->post);
				$this->response->redirect($this->url->link('extension/module/pavproducttabs', 'token=' . $this->session->data['token'].'&module_id='.$this->request->get['module_id'], 'SSL'));
			}
		...
		// RENDER
		$template = 'extension/module/pavproducttabs.tpl';
	...
	public function _data(){
		if (!isset($this->request->get['module_id'])) {
			$this->data['action'] = $this->url->link('extension/module/pavproducttabs', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('extension/module/pavproducttabs', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
	...
	public function _breadcrumbs(){
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/pavproducttabs', 'token=' . $this->session->data['token'], 'SSL'),
   		);
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/pavproducttabs')) {
